...
/**
 * Instance lifecycle (offline): backup / restore / clone, scheduled backups + GFS retention, outbound mail and the environment editor.
 *
...
import { LockStore, ManifestStore, generateInstanceSecrets, instancePaths, serverInventoryPath, writeInstanceSecrets } from '@shm/instances';
import { instanceBackup, instanceBackupPrune, instanceBackupScheduleGet, instanceBackupScheduleSet, instanceClone, instanceGetEnv, instanceGetMailer, instanceInstall, instanceList, instanceLogs, instanceEnable, instanceRemove, instanceRestore, instanceSetAddress, instanceSetEnv, instanceSetMailer, instanceSetName, instanceSupportBundle, serverInit, serverPurge, serverRunScheduledBackups } from '@shm/app-actions';
import type { ActionDeps } from '@shm/app-actions';
import { buildActionDeps, parseEnv, readExample } from './cli-test-support.js';
import { formatSteps } from './output.js';
